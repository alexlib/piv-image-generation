...
def calculate_background_intensity(
    CHANNEL_DEPTH_MICRONS,
    PARTICLE_VOLUME_FRACTION,
    PARTICLE_DIAMETER_MICRONS,
    WAVELENGTH_MICRONS,
    MAGNIFICATION,
    NA,
    WORKING_DISTANCE_MICRONS,
    FOCAL_LENGTH_MICRONS,
    OBJECT_PLANE_DISTANCE_MICRONS
):
    """
